        ...
        >
          {state.npcFaceImageUrl && (
            ...
            <img
              ...
              alt={state.npcName}
              className="h-8 w-8 flex-shrink-0 rounded-full border-2 border-slate-700/60 object-cover object-top"
            />
          )}
          <div className="flex min-w-0 flex-1 items-center gap-2">
            ...
            <span
              className={`mood-dot inline-block h-2 w-2 flex-shrink-0 rounded-full ${getMoodTheme(state.mood).dot}`}
            />
          </div>
          {/* Mini objective donut */}
          <div className="relative h-7 w-7 flex-shrink-0">
            <div
              className="h-7 w-7 rounded-full border border-slate-700/45"
              style={{
                background: donutBackground(objectiveProgressValue, "#34d399"),
              }}
            />
            <div className="absolute inset-[22%] flex items-center justify-center rounded-full bg-slate-900/95">
              <span className="font-[family-name:var(--font-mono)] text-[8px] leading-none text-slate-200">
            ...
            <>
              ...
              >
                <input
                  ...
                  className="flex-1 rounded-xl border border-slate-700/50 bg-slate-800/40 px-3 py-2.5 text-sm text-white backdrop-blur-sm placeholder-slate-500 transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className={`btn-press rounded-xl px-3 py-2.5 transition-all ${
                      recording
                  ...
                  <button
                    ...
                    className="btn-press flex-1 rounded-xl bg-gradient-to-r from-blue-500 to-blue-700 px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-blue-600/20 transition-all hover:from-blue-500 hover:to-blue-600 hover:shadow-blue-500/30 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {t("send")}
                  </button>
                  {/* Overflow "..." */}
                  <button
                    ...
                    className="btn-press rounded-xl border border-slate-700/50 bg-slate-800/40 px-3 py-2.5 text-slate-400 transition-all hover:border-slate-600 hover:bg-slate-700/50"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
                ...
                {overflowOpen && (
                  <>
                    ...
                    />
                    <div className="absolute bottom-full right-0 z-50 mb-2 w-64 animate-in slide-in-from-bottom-2 rounded-xl border border-slate-700/50 bg-slate-900 p-2 shadow-2xl">
                      {/* Speed slider */}
                      ...
                      <button
                        ...
                        className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-300 transition-colors hover:bg-slate-800"
                      >
                        {npcMuted ? (
                          <svg
                      ...
                      <button
                        ...
                        className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-red-400 transition-colors hover:bg-red-950/30 disabled:opacity-50"
                      >
                        <svg
                          className="h-5 w-5"
                          fill="none"
              ...
              >
                <input
                  ...
                  disabled={sending || recording}
                  className="flex-1 rounded-xl border border-slate-700/50 bg-slate-800/40 px-4 py-3 text-base text-white backdrop-blur-sm placeholder-slate-500 transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 md:px-5"
                />
                <div className="flex gap-3">
                  {/* Speed Control */}
                  <div className="flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800/50 px-3 py-3">
                    <svg
                    ...
                    <input
                      ...
                      title={`Speech speed: ${ttsSpeed.toFixed(1)}x`}
                      className="h-1 w-20 cursor-pointer appearance-none rounded-lg bg-slate-700 accent-blue-500"
                    />
                  ...
                  <button
                    ...
                    className="btn-press rounded-xl border border-slate-700/50 bg-slate-800/40 px-4 py-3 text-slate-400 transition-all hover:border-slate-600 hover:bg-slate-700/50"
                  >
                    {npcMuted ? (
                      <svg
                        className="h-5 w-5"
                  ...
                  <button
                    ...
                    disabled={sending || transcribing}
                    title={recording ? t("stopRecording") : t("startRecording")}
                    className={`btn-press rounded-xl px-4 py-3 transition-all ${
                      recording
                        ? "animate-pulse bg-red-600 text-white shadow-lg shadow-red-600/30"
                        : "border border-slate-700/50 bg-slate-800/40 text-slate-400 hover:border-slate-600 hover:bg-slate-700/50"
                    } disabled:opacity-50`}
                  ...
                  <button
                    type="submit"
                    disabled={sending || !input.trim() || recording}
                    className="btn-press rounded-xl bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-3 text-base font-medium text-white shadow-lg shadow-blue-600/20 transition-all hover:from-blue-500 hover:to-blue-600 hover:shadow-blue-500/30 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {t("send")}
                  </button>
                  <button
                    ...
                    onClick={onQuit}
                    disabled={sending || quitting || recording}
                    className="btn-press rounded-xl border border-slate-700/50 bg-slate-800/40 px-4 py-3 text-sm text-slate-400 transition-all hover:border-slate-600 hover:bg-slate-700/50 disabled:opacity-50"
                  >
                    {quitting ? "..." : t("quit")}
                  </button>
                </div>
